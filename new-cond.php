...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "update-cond")) {
  $insertSQL = sprintf("INSERT INTO condominios (id_cond, nome_cond) VALUES (%s, %s)",
...
<h3>Cadastrar novo Condominio</h3>
<input name="id" type="hidden" id="id_user">
<input name="condominio" type="text" class="form-control1 control3" id="nome" placeholder="Insira o nome">
<hr>
<input type="submit" value="Cadastrar">
<input type="hidden" name="MM_insert" value="update-cond">
</form>
</div>
</div>
</div>
