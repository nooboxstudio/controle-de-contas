...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "edtuser")) {
  $updateSQL = sprintf("UPDATE usuarios SET name_user=%s, email_user=%s, password=%s WHERE id=%s",
...
<form method="POST" action="<?php echo $editFormAction; ?>" name="edtuser" class="com-mail" id="edtuser">
<input name="id_user" type="hidden" id="id_user" value="<?php echo $row_edtusuarios['id']; ?>">
<label>Nome: </label>
<input name="nome" type="text" class="form-control1 control3" id="nome" value="<?php echo $row_edtusuarios['name_user']; ?>">
<label>E-mail :  </label>
<input name="email" type="text" class="form-control1 control3" id="email" value="<?php echo $row_edtusuarios['email_user']; ?>">
<label>Senha :  </label>
<input name="senha" type="text" class="form-control1 control3" id="senha" value="<?php echo $row_edtusuarios['password']; ?>">
<hr>
<input type="submit" value="Atualizar">
<input type="hidden" name="MM_update" value="edtuser">
</form>
</div>
</div>
</div>
